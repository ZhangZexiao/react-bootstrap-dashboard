    ...
    return (
        <div className="overview-panel">
            ...
            <div className="flex-container-space-between-flex-items">
                <CaptionNumber caption={totalFilesCaption} tooltip={totalFilesTooltip} number={props.vaultData.totalNumberOfFiles} />
                <VerticalLine />
                <CaptionNumber caption={totalIptFilesCaption} tooltip={totalIptFilesTooltip} number={props.vaultData.totalNumberOfIptFiles} />
                <VerticalLine />
                <CaptionNumber caption={totalIamFilesCaption} tooltip={totalIamFilesTooltip} number={props.vaultData.totalNumberOfIamFiles} />
                <VerticalLine />
                <CaptionNumber caption={totalDwgFilesCaption} tooltip={totalDwgFilesTooltip} number={props.vaultData.totalNumberOfDwgFiles} />
            </div>
        </div>
    )
}
